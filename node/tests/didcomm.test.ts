...
let new_wallet = async function() {
    let w = await walletUtils.newWallet("did:xyz:ulapcuhsatnpuhza930hpu34n", "superbpass");
    let populated = await walletUtils.newKey(
        w,
